...
export function ProgramGrid() {
    ...
    return (
        <section id="programs" className="py-16 relative z-10 overflow-x-hidden bg-gradient-to-b from-white to-slate-50 dark:from-slate-950 dark:to-slate-900 px-5 scroll-mt-24">
